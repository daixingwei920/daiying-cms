...
require_once __DIR__ . '/src/OAuthMailboxMailProvider.php';
...
return static function (PluginContext $context): void {
    ...
    if (method_exists($context, 'registerMailProvider')) {
        ...
        $context->registerMailProvider(new OAuthMailboxMailProvider('gmail', $repository, $oauth, $factory));
        $context->registerMailProvider(new OAuthMailboxMailProvider('outlook', $repository, $oauth, $factory));
    }
