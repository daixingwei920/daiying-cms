...
$basePath = dy_site_url('/search?q=' . rawurlencode($query));
?>
<!doctype html>
<html lang="zh-CN">
...
<section class="hero compact-hero">
    <div class="wrap">
        ...
        <form class="search-panel" action="<?= $context->e(dy_site_url('/search')) ?>" method="get" role="search">
...
<main class="wrap layout layout-<?= $context->e($layout) ?>">
    <section class="post-list" aria-label="搜索结果">
        ...
        <?php elseif ($items === []): ?>
            <article class="empty"><h2>没有找到匹配内容</h2><p>换一个更短的关键词试试，或返回文章归档浏览全部内容。</p><p><a href="<?= $context->e(dy_site_url('/articles')) ?>">浏览全部文章</a></p></article>
        <?php else: ?>
    ...
    <?php if (dy_bool($context, 'sidebar_enabled', true)): ?>
        <aside class="sidebar" aria-label="侧栏">
            ...
            <section class="side-block"><h2>快速入口</h2><ul><li><a href="<?= $context->e(dy_site_url('/')) ?>">返回首页</a></li><li><a href="<?= $context->e(dy_site_url('/articles')) ?>">全部文章</a></li><li><a href="<?= $context->e(dy_site_url('/sitemap.xml')) ?>">站点地图</a></li></ul></section>
        </aside>
    <?php endif; ?>
</main>
