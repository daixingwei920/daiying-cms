...
if (!function_exists('dy_setting')) {
    ...
    function dy_first_image_html(array $media, string $class = 'entry-cover'): string
    {
        ...
        return '<div class="' . htmlspecialchars($class, ENT_QUOTES, 'UTF-8') . ' cover-fallback" aria-hidden="true"><span></span></div>';
    }
