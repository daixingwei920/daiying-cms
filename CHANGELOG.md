...
- Kept Groq reasoning hidden by default for both the Groq preset and custom OpenAI-compatible configurations pointing at `api.groq.com`.
- Preserved the shared adapter architecture and the 1.2.0 cross-version upgrade floor.
- Public install package: `daiying-cms-1.2.57-stable.zip`.
- Release URL: <https://github.com/daixingwei920/daiying-cms/releases/tag/v1.2.57>.
...
- Re-aligned Core update packaging so admin CSS, admin JS, and `system/official-plugins.php` all remain valid Core-owned operational support files.
- Preserved the 1.2.0 cross-version upgrade floor.
- Public install package: `daiying-cms-1.2.56-stable.zip`.
- Release URL: <https://github.com/daixingwei920/daiying-cms/releases/tag/v1.2.56>.

## 1.2.55 - 2026-09-13

- Superseded by 1.2.56 before GitHub release publication because the official update server allowlist was missing `public/assets/admin/admin.js`.
- Use 1.2.56 as the public stable Groq/OpenAI-compatible adapter release.

## 1.2.54 - 2026-09-13

- Superseded by 1.2.55 before GitHub release publication because the initial update-server package was narrower than the final release parity gate expected.
- Use 1.2.55 as the public stable Groq/OpenAI-compatible adapter release.
