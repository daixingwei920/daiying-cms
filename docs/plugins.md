...
| `official.mail` | `0.2.0-alpha.1` | plugin | Official Mail Provider bridge and Webmail alpha for Gmail/Outlook OAuth accounts, inbox, message viewing, attachments, send/reply, and SMTP providers. |
