...
final class Application
{
    ...
    private static function registerCoreRoutes(Router $router, Settings $settings, string $rootPath, FileLogger $logger, string $mode, PluginRuntimeRegistry $pluginRuntime): void
    {
        ...
        $router->patch('/api/v1/contents/{id}', [$apiV1, 'contents']);
        $router->delete('/api/v1/contents', [$apiV1, 'contents']);
        $router->delete('/api/v1/contents/{id}', [$apiV1, 'contents']);
        $router->get('/api/v1/pages', [$apiV1, 'contents']);
        $router->post('/api/v1/pages', [$apiV1, 'contents']);
        $router->patch('/api/v1/pages/{id}', [$apiV1, 'contents']);
        $router->delete('/api/v1/pages/{id}', [$apiV1, 'contents']);
        $router->get('/api/v1/categories', [$apiV1, 'categories']);
        $router->post('/api/v1/categories', [$apiV1, 'categories']);
        $router->patch('/api/v1/categories/{id}', [$apiV1, 'categories']);
        $router->delete('/api/v1/categories/{id}', [$apiV1, 'categories']);
        $router->get('/api/v1/tags', [$apiV1, 'tags']);
        $router->post('/api/v1/tags', [$apiV1, 'tags']);
        $router->patch('/api/v1/tags/{id}', [$apiV1, 'tags']);
        $router->delete('/api/v1/tags/{id}', [$apiV1, 'tags']);
        $router->get('/api/v1/media', [$apiV1, 'media']);
        $router->post('/api/v1/media', [$apiV1, 'media']);
        $router->get('/api/v1/comments', [$apiV1, 'comments']);
        $router->patch('/api/v1/comments/{id}', [$apiV1, 'comments']);
        $router->delete('/api/v1/comments/{id}', [$apiV1, 'comments']);
        $router->get('/api/v1/users', [$apiV1, 'users']);
