...
final class BlockRenderer
{
    ...
    public function __construct(private readonly array $media = [], private readonly array $cardProducts = [])
    {
    }
    ...
    private function paragraph(array $data): string
    {
        ...
        $style = in_array(($data['style'] ?? 'body'), ['body', 'lead', 'small'], true) ? (string) $data['style'] : 'body';
