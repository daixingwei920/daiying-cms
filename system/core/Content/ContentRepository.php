...
final class ContentRepository
{
    ...
    private const RESERVED_SLUGS = ['install', 'admin', 'login', 'health', 'recovery', 'api', 'articles', 'category', 'tag', 'sitemap.xml', 'robots.txt'];
    ...
    {
        if ($slug === '' || preg_match('/^[a-z0-9-]{1,191}$/', $slug) !== 1) {
            return '';
        }
        if ($type === 'article') {
